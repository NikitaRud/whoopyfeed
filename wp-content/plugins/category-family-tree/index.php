...
{
    private $p,$q;
    public function Category_Family_Tree()
    {
    ...
    public function getParentCategory_()
    {
    ...
    public function form($instance)
    {
        ...
        ?>
          ...
          <p>
           <input type="checkbox" id="<?php echo $this->get_field_id('empty');
                ?>" name="<?php echo $this->get_field_name('empty');
                ?>" <?php if ($instance['empty']) {
            echo 'checked="checked"';
        }
                ?> />
           <label for="<?php echo $this->get_field_id('empty');
                ?>">Show Empty Cats ?</label>
          </p>
          <p>
           <input type="checkbox" id="<?php echo $this->get_field_id('count');
    ...
    public function widget($args, $instance)
    {
        ...
        if ($thiscat) {
            ...
            if (!empty($subcategories)) {
                ...
                $li .= '<strong><a href="'.get_category_link($subcat->term_id).'" title="'.$subcat->name.'">'.$subcat->name.'</a></strong>'; else :
                                  $li .= '<li class="cat-item cat-item-'.$subcat->term_id.$current.'">';
        ...
        if (isset($category_value) && $category_value != '') {
            ...
            echo '<li style="list-style: inside cirle;"><a href="'.get_category_link($cat_id).'" title="'.get_cat_name($cat_id).'">Topics in '.get_cat_name($cat_id).'</a></li>';
    ...
    function register_plugin_styles() {
        wp_register_style('Category_Family_Tree', plugins_url('category-family-tree/css/style.css'));
        wp_enqueue_style( 'Category_Family_Tree' );
    }
}
